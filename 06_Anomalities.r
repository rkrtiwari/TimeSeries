...
# alpha_dots control the transparency
...
# The alpha and max_anoms are the two parameters that control the 
# anomalize() function. Here's how they work.

# Alpha: Controls the width of the "normal" range. Lower values are more 
# conservative while higher values are less prone to incorrectly 
# classifying "normal" observations
...
# We can generate anomalous data to illustrate how each method work 
